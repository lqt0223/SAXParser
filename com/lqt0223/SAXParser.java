/* TODO
* 1. syntax check with detailed error information
* 2. CDATA
...
public class SAXParser {
    ...
    public void parse(String path) throws IOException, SyntaxError {
    ...
    private static void handleParser(char c) throws IOException, SyntaxError {
